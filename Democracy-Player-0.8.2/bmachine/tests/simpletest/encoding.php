<?php
     ...
     *	@version	$Id: encoding.php,v 1.1 2005/08/20 13:36:02 mitchc2 Exp $
     */
    ...
    class SimpleAttachment {
         ...
         */
        function SimpleAttachment($key, $content, $filename, $mime = null) {
            $this->_key = $key;
    ...
    class SimpleEncoding {
         ...
         *    @access public
         */
        function attach($key, $content, $filename, $mime = null) {
