...
xgettext -k_ -kN_ -o messages.pot ../../platform/osx/English.lproj/*.strings `find ../../ -name '*.py' -and -not -path '*.svn*' -and -not -path '*build*' -and -not -path '*dist*'` ../../platform/gtk-x11/glade/democracy.glade.h ../../platform/windows-xul/xul/chrome/locale/en-US/*.dtd.h ../../platform/windows-xul/xul/chrome/locale/en-US/*.dtd.template.h
