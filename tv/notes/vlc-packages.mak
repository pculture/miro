###############################################################################
# This is a replacement for the file extras/contrib/src/packages.mak in the   #
# VLC distribution. It has updated URLs, since some of the URLs in VLC CVS    #
# are out of date. Copy it over VLC's packages.mak.                           #
#                                                                             #
# -- gschmidt 4/5/05                                                          #
###############################################################################
...
FREETYPE2_URL=http://unc.dl.sourceforge.net/sourceforge/freetype/freetype-$(FREETYPE2_VERSION).tar.gz
