...
/*
 * fixed-list-store-module.c -- Python module that stores the FixedListStore
 * wrapper.
 */

#include <pygobject.h>

void miro_fixed_list_store_register_classes (PyObject *d); 
extern PyMethodDef miro_fixed_list_store_functions[];
