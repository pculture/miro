...
!macro _OpenCandyDevModeMsg OC_DEV_MSG OC_DEV_ERROR OC_FAQ_ID
	...
	!endif
	!ifdef NSIS_UNICODE
		System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742LogDevModeMessageW(w, i, i)(r0, ${OC_TMP_DEV_ERROR}, ${OC_FAQ_ID})? c"
	!else
		System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742LogDevModeMessage(m, i, i)(r0, ${OC_TMP_DEV_ERROR}, ${OC_FAQ_ID})? c"
	!endif
	Pop $0
...
${If} $OCHasBeenInitialized <> ${OC_NSIS_TRUE}
	...
	ClearErrors
	Push $0
	System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742LoadOpenCandyDLL()i().r0? c"
	...
	${if} $OCNoCandy == ${OC_NSIS_FALSE}
		...
		!ifdef NSIS_UNICODE
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742SetCmdLineValuesW(w)i(r0).r1? c"
		!else
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742SetCmdLineValues(m)i(r0).r1? c"
		!endif

		System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742GetNoCandy()i().r1? c"
	...
	${if} $OCNoCandy == ${OC_NSIS_FALSE}
		...
		!ifdef OC_ADV_OPTIONS
			!ifdef NSIS_UNICODE
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742SetClientAdvancedOptionsW(w)('${OC_ADV_OPTIONS}')? c"
			!else
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742SetClientAdvancedOptions(m)('${OC_ADV_OPTIONS}')? c"
			!endif
		!endif

		!ifdef NSIS_UNICODE
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742Init2W(w, w, w, w, i, i, i)i(r0, r1, r2, r5, r3, ${OC_MAX_INIT_TIME}, r4).s? c"
		!else
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742Init2A(m, m, m, m, i, i, i)i(r0, r1, r2, r5, r3, ${OC_MAX_INIT_TIME}, r4).s? c"
		!endif
...
${AndIf} $OCNoCandy == ${OC_NSIS_FALSE}
	...
	!endif
	System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742SetOCOfferEnabled(i)(${OC_TMP_OFFER_ENABLED})? c"
...
${AndIf} $OCNoCandy == ${OC_NSIS_FALSE}
	...
	!endif
	Push $0
	System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742GetAsyncOfferStatus(i)i(${OC_TMP_DETERMINES_OFFER_ENABLED}).r0? c"
	Exch $0
...
${AndIf} $OCNoCandy == ${OC_NSIS_FALSE}
	...
	${If} $OCAttached == ${OC_NSIS_TRUE}
		System::Call "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742Detach()i.r0? c"
		StrCpy $OCAttached ${OC_NSIS_FALSE}
	${EndIf}

	${If} $OCHasReachedOCPage == ${OC_NSIS_FALSE}
		System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742GetAsyncOfferStatus(i)i(${OC_STATUS_QUERY_DETERMINESOFFERENABLED}).r0? c"
	...
	${If} $OCUseOfferPage == ${OC_NSIS_TRUE}
		...
		!ifdef NSIS_UNICODE
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742GetBannerInfoW(i, i)i(r3, r4).r0? c"
		!else
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742GetBannerInfo(i, i)i(r3, r4).r0? c"
		!endif
		...
		${Else}
			...
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742NSISAdjust(i, i, i, i, i)i(r3, 14, 70, 470, 228).r0? c"
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742RunDialog(i)i(r3).r0? c"
...
Function _OpenCandyPageLeaveFn
	Push $0
	System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742CanLeaveOfferPage()i.r0? c"
...
!endif
	Push $0
	${If} $OCUseOfferPage == ${OC_NSIS_TRUE}
		System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742GetOfferType() i.r0? c"
		${If} $0 == ${OC_OFFER_TYPE}
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742PrepareDownload()i().r0? c"
			System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742GetOfferState()i().r0? c"
			${If} $0 == ${OC_OFFER_CHOICE_ACCEPTED}
				System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742StartDLMgr2Download()? c"
			${EndIf}
		${EndIf}
	${EndIf}
	Pop $0
...
${AndIf} $OCNoCandy == ${OC_NSIS_FALSE}
	Push $0
	!insertmacro _OpenCandyExecOfferInternal ${OC_OFFER_TYPE_NORMAL}
	System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742SignalProductInstalled()i.r0? c"
...
${AndIf} $OCNoCandy == ${OC_NSIS_FALSE}
	...
	System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742SignalProductFailed()i.r0? c"
	${EndIf}
	...
	${If} $OCAttached == ${OC_NSIS_TRUE}
		...
		StrCpy $OCAttached ${OC_NSIS_FALSE}
	${EndIf}	
   	System::Call /NOUNLOAD "$PLUGINSDIR\OCSetupHlp.dll::OCPRD742Shutdown()i.r0? cu"
	Pop $0
${EndIf}
!macroend
