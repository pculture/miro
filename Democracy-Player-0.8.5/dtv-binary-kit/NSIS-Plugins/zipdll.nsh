...
!macro ZIPDLL_EXTRACT SOURCE DESTINATION FILE
  ...
  !ifdef LANG_ENGLISH
    ...
    ;StrCmp $LANGUAGE ${LANG_ENGLISH} 0 END_ENGLISH
...
;END_ENGLISH:
  ...
  !ifdef LANG_HUNGARIAN
    ...
    StrCmp $LANGUAGE ${LANG_HUNGARIAN} 0 END_HUNGARIAN
...
END_HUNGARIAN:
  ...
  !ifdef LANG_FRENCH
    ...
    StrCmp $LANGUAGE ${LANG_FRENCH} 0 END_FRENCH
...
END_FRENCH:
  ...
  !ifdef LANG_GERMAN
    ...
    StrCmp $LANGUAGE ${LANG_GERMAN} 0 END_GERMAN
...
END_GERMAN:
  ...
  !ifdef LANG_SPANISH
    ...
    StrCmp $LANGUAGE ${LANG_SPANISH} 0 END_SPANISH
...
END_SPANISH:
  ...
  !ifdef LANG_PORTUGUESEBR
    ...
    StrCmp $LANGUAGE ${LANG_PORTUGUESEBR} 0 END_PORTUGUESEBR
...
END_PORTUGUESEBR:
  ...
  StrCmp $LANGUAGE ${LANG_TRADCHINESE} 0 END_TRADCHINESE
...
END_TRADCHINESE:
  ...
  StrCmp $LANGUAGE ${LANG_SIMPCHINESE} 0 END_SIMPCHINESE
...
END_SIMPCHINESE:
  ...
  !ifdef LANG_LITHUANIAN
    ...
    StrCmp $LANGUAGE ${LANG_LITHUANIAN} 0 END_LITHUANIAN
...
END_LITHUANIAN:
  ...
  !ifdef "LANG_POLISH"
    ...
    strcmp $LANGUAGE ${LANG_POLISH} 0 END_POLISH
...
END_POLISH:
  ...
  !ifdef "LANG_KOREAN"
    strcmp $LANGUAGE ${LANG_KOREAN} 0 END_KOREAN
      Push "  ¿À·ù : %s"
...
END_KOREAN:
  ...
  !ifdef "LANG_RUSSIAN"
    ...
    strcmp $LANGUAGE ${LANG_RUSSIAN} 0 END_RUSSIAN
...
END_RUSSIAN:
  ...
  !ifdef LANG_ARABIC
    ...
    StrCmp $LANGUAGE ${LANG_ARABIC} 0 END_ARABIC
...
END_ARABIC:
  ...
  !ifdef LANG_DANISH
    ...
    StrCmp $LANGUAGE ${LANG_DANISH} 0 END_DANISH
...
END_DANISH:
  ...
  !ifdef LANG_CROATIAN
    ...
    StrCmp $LANGUAGE ${LANG_CROATIAN} 0 END_CROATIAN
